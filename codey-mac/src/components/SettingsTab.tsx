...
// The install chip and the env editor moved to agentSettingsUi.tsx, next to
// the only page that renders them, so Settings ▸ Agents has one style
// vocabulary rather than pieces inherited from here.
