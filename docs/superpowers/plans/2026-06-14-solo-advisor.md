...
Run: `cd /path/to/codey && npm run build:core`
...
Run: `cd /path/to/codey && npm test -w @codey/core -- solo-advisor`
...
Run: `cd /path/to/codey && npm test -w @codey/core`
...
Run: `cd /path/to/codey && npm run build:gateway`
Expected: exits 0.
...
Run: `cd /path/to/codey/codey-mac && npm run build`
